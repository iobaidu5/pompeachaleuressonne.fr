...
$(document).ready(function() {
  ...
  $('#menu ul li a').each(function() {
      let linkPath = new URL(this.href).pathname.replace(/\/$/, '');
      const isHomePage = currentPath === '/' || currentPath === '/accueil.html';
      const isHomeLink = linkPath === '/' || linkPath.endsWith('/accueil.html');
